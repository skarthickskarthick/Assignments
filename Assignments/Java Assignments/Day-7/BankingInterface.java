...
abstract  class RBI
{
   static ArrayList <Account> sbiaccounts=new ArrayList<>();
    ...
    abstract void createAccount(int acno, AccountType accountType, Customer c, double balance);
...
class SBI extends RBI
{
  //  static ArrayList <Account> sbiaccounts=new ArrayList<>();
    ...
    {
        return withdrawlimit+500;
    }
    public   double GetMinimumBalance()
    {
        return minimumbalance+50;
    }
...
class ICICI extends RBI
{
   // static ArrayList <Account> iciciaccounts=new ArrayList<>();
    ...
    public   double GetWithdrawalLimit()
    {
        return withdrawlimit+1000;
    }
    public   double GetMinimumBalance()
    {
        return minimumbalance+450;
    }
    public void createAccount(int acno, AccountType accountType, Customer c, double balance)
    {
...
//        Composition:
//        A bank account belongs to a specific bank.
//        If the bank closes, the accounts under it are also terminated.
//
//        Aggregation:
//        A customer exists independently.
//        Even if they close their account in a bank, they (the customer) still exist.
